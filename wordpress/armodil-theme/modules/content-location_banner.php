...
<section class="py-12 px-6 lg:px-12 bg-[#183a6b] text-white">
    <div class="max-w-6xl mx-auto">
        ...
        <?php if ($button_text && $button_link) : ?>
            <a href="<?php echo esc_url($button_link); ?>" class="inline-flex items-center justify-center bg-accent hover:bg-[#e6b800] text-teal-700-dark font-bold text-lg py-3 px-6 rounded transition-colors duration-300">
