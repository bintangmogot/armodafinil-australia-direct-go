...
?>
<section class="py-14 lg:py-20 px-6 lg:px-12 bg-teal-600">
    <div class="max-w-4xl mx-auto text-center">
        ...
        <div class="bg-surface rounded-2xl p-8 lg:p-12 text-left shadow-xl max-w-2xl mx-auto">
            <form id="armo-review-form" method="POST" class="flex flex-col gap-6">
                ...
                <!-- Rating -->
                <div>
                    <label class="block text-sm font-bold text-teal-700 mb-2">Your overall rating *</label>
                ...
                <!-- Title -->
                <div>
                    <label class="block text-sm font-bold text-teal-700 mb-2">Title of your review *</label>
                    <input type="text" name="review_title" placeholder="Enter your title" class="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-gray-700 focus:outline-none focus:border-teal-600 transition-colors" required>
                </div>

                <!-- Review Content -->
                <div>
                    <label class="block text-sm font-bold text-teal-700 mb-2">Your review *</label>
                    <textarea name="review_content" placeholder="Write your review" rows="4" class="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-gray-700 focus:outline-none focus:border-teal-600 transition-colors resize-none" required></textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Name -->
                    <div>
                        <label class="block text-sm font-bold text-teal-700 mb-2">Your name *</label>
                        <input type="text" name="review_name" placeholder="Enter your name" class="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-gray-700 focus:outline-none focus:border-teal-600 transition-colors" required>
                    </div>

                    <!-- Email -->
                    <div>
                        <label class="block text-sm font-bold text-teal-700 mb-2">Your email address *</label>
                        <input type="email" name="review_email" placeholder="Enter your email" class="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-gray-700 focus:outline-none focus:border-teal-600 transition-colors" required>
                    </div>
                </div>
                ...
                <div class="mt-4 text-center">
                    <button type="submit" id="review-submit-btn" class="bg-teal-600 text-white font-bold py-4 px-10 rounded-full hover:bg-teal-700 transition-colors w-full md:w-auto">
                        Submit your review
                    </button>
                </div>
            </form>
