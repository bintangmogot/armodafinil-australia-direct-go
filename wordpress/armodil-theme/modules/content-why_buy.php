...
<section class="py-16 px-6 lg:px-12 bg-white">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="w-full mb-12">
            <?php if ($heading): ?>
                <h2 class="text-3xl lg:text-4xl font-bold text-teal-700 mb-4 leading-tight">
            ...
            <?php if ($intro): ?>
                <div class="prose prose-lg text-teal-700/80 leading-relaxed max-w-none">
                    <?php echo armo_content($intro); ?>
                </div>
            <?php else: ?>
                <!-- <div class="text-teal-700/80 text-base md:text-lg leading-relaxed">
        ...
        <?php if (have_rows('features')): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                <?php while (have_rows('features')):
                    ...
                    ?>
                    <div
                        class="bg-surface rounded-2xl p-6 lg:p-8 text-teal-700 hover:shadow-lg hover:shadow-teal-700/5 hover:scale-[1.01] transition-all duration-300 flex flex-col items-start gap-4">
                        <?php if ($icon_url): ?>
                        ...
                        <div>
                            <?php if ($title): ?>
                                <h3 class="text-lg lg:text-xl font-bold text-teal-700 mb-2 leading-snug">
                                    <?php echo esc_html($title); ?>
                                </h3>
                            <?php endif; ?>

                            <?php if ($content): ?>
                                <p class="text-teal-700/80 text-base md:text-lg leading-relaxed">
        ...
        <?php else: ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 text-teal-700">

                <!-- Card 1 -->
                <div
                    class="bg-surface rounded-2xl p-6 lg:p-8 hover:shadow-lg hover:shadow-teal-700/5 hover:scale-[1.01] transition-all duration-300 flex flex-col items-start gap-4">
                    <div class="w-12 h-12 lg:w-14 lg:h-14 flex items-center justify-start flex-shrink-0 text-teal-700">
                    ...
                    <div>
                        <h3 class="text-lg lg:text-xl font-bold text-teal-700 mb-2 leading-snug">Australia-Focused Service
                        </h3>
                        <p class="text-teal-700/80 text-base md:text-lg leading-relaxed">We built our platform specifically
                ...
                <div
                    ...
                    <div>
                        <h3 class="text-lg lg:text-xl font-bold text-teal-700 mb-2 leading-snug">Discreet Shipping</h3>
                        <p class="text-teal-700/80 text-base md:text-lg leading-relaxed">All orders are packed discreetly
                ...
                <div
                    ...
                    <div>
                        <h3 class="text-lg lg:text-xl font-bold text-teal-700 mb-2 leading-snug">Premium Quality Products
                        </h3>
                        <p class="text-teal-700/80 text-base md:text-lg leading-relaxed">We stock trusted Armodafinil
                ...
                <div
                    ...
                    <div>
                        <h3 class="text-lg lg:text-xl font-bold text-teal-700 mb-2 leading-snug">Fast Dispatch</h3>
                        <p class="text-teal-700/80 text-base md:text-lg leading-relaxed">Orders are processed quickly to
                ...
                <div
                    ...
                    <div>
                        <h3 class="text-lg lg:text-xl font-bold text-teal-700 mb-2 leading-snug">Secure Ordering Process
                        </h3>
                        <p class="text-teal-700/80 text-base md:text-lg leading-relaxed">Our checkout process is simple,
                ...
                <div
                    ...
                    <div>
                        <h3 class="text-lg lg:text-xl font-bold text-teal-700 mb-2 leading-snug">Responsive Support Team
                        </h3>
                        <p class="text-teal-700/80 text-base md:text-lg leading-relaxed">We stock trusted Armodafinil
                            brands sourced from reputable manufacturers with strong global reputations.</p>
                    </div>
