...
<section class="bg-white">
    <div class="max-w-7xl mx-auto px-6 pb-12 lg:pb-20">
        ...
        <?php if ($heading) : ?>
            <h2 class="text-2xl md:text-3xl font-bold text-center text-teal-700 mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-12">
                ...
                ?>
                    <div class="relative bg-gradient-review rounded-xl shadow-lg pt-10 pb-6 px-4 text-center">
                        <div class="absolute -top-6 left-1/2 -translate-x-1/2 w-16 h-16 bg-accent rounded-full flex items-center justify-center text-teal-700 text-xl font-bold shadow-md">
                            <?php echo $count; ?>
                        </div>
