            ...
            <div class="lg:w-3/4 flex flex-col gap-6" id="reviews-wrapper">
                ...
                <div id="reviews-pagination" class="mt-8 flex flex-col items-center">
                    ...
                    <?php if ( $reviews->max_num_pages > $paged ) : ?>
                        <a href="<?php echo esc_url( get_pagenum_link( $paged + 1 ) ); ?>" id="load-more-btn" class="group inline-flex items-center gap-2 bg-teal-600 text-white font-bold py-4 px-10 rounded-full hover:bg-teal-700 transition-colors">
                            Load More
