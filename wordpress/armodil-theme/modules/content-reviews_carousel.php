        ...
        <?php if ($reviews->have_posts()): ?>
            <div class="relative group">
                ...
                <div id="<?php echo $carousel_id; ?>-prev" role="button"
                    class="carousel-arrow absolute left-0 top-1/2 -mt-5 -ml-8 md:-ml-12 z-10 w-10 h-10 flex items-center justify-center text-primary hover:text-teal-700 cursor-pointer"
                    aria-label="Previous">
                ...
                <div id="<?php echo $carousel_id; ?>-next" role="button"
                    class="carousel-arrow absolute right-0 top-1/2 -mt-5 -mr-8 md:-mr-12 z-10 w-10 h-10 flex items-center justify-center text-primary hover:text-teal-700 cursor-pointer"
                    aria-label="Next">
                    <svg class="w-8 h-8 transition-transform duration-300" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24">
