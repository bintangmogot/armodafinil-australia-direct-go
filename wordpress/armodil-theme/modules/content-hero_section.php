...
<section class="hero relative overflow-hidden md:min-h-[600px] lg:h-[80vh] max-h-[964px]">
    <?php if ($image) : ?>
        ...
        <div class="absolute inset-0 bg-gradient-to-r from-teal-700/90 via-teal-700/20 to-transparent lg:hidden"></div>
        <div class="absolute inset-0 bg-gradient-to-t from-teal-700/20 to-transparent lg:hidden"></div>
    <?php endif; ?>
