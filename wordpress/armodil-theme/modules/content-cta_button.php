...
<section class="pt-2 pb-8 lg:pt-4 lg:pb-12 bg-transparent flex justify-center">
    <div class="max-w-7xl mx-auto px-6 lg:px-12 text-center w-full">
        ...
        <div class="hidden md:inline-block">
            <a href="<?php echo esc_url($button_link); ?>" class="group inline-flex items-center justify-center gap-2 bg-teal-600 hover:bg-[#dc0000] text-white font-bold text-base lg:text-lg px-6 lg:px-10 py-3 lg:py-4 rounded-full no-underline transition-all hover:shadow-lg hover:shadow-black/30">
                <span class="whitespace-nowrap"><?php echo esc_html($button_text); ?></span>
                <svg class="w-5 h-5 flex-shrink-0 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 28 28">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"></path>
                </svg>
