    ...
    <div class="max-w-7xl mx-auto">
        <?php if (have_rows('boxes')) : ?>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                ...
                ?>
                    <div class="bg-surface rounded-2xl p-6 lg:p-8 hover:shadow-lg hover:shadow-teal-700/5 transition-all duration-300 border border-transparent hover:border-teal-700/10">
                        <?php if ($image) : ?>
                            <div class="mb-5">
