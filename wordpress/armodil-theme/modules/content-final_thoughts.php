    ...
    <div class="relative z-10 max-w-6xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pt-4">
            ...
            <?php if ($cta_text && $cta_link): ?>
                <a href="<?php echo esc_url($cta_link); ?>" class="bg-teal-600 hover:bg-[#cc0000] text-white font-semibold text-base lg:text-lg px-6 py-4 rounded-lg shadow-lg flex items-center gap-4 transition-colors max-w-sm w-full md:w-auto">
